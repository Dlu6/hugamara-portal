...
const Login = () => {
  ...
  // Mock outlets data - in real app this would come from API
  const outlets = [
    {
      id: "cs",
    ...
    {
      id: "villa",
      name: "The Villa Ug - Bukoto Ntinda Rd",
      type: "Nightclub",
      icon: Users,
    },
    {
      id: "luna",
      name: "Luna - Cube Kisementi",
      type: "Nightclub",
      icon: Clock,
    },
    {
      id: "cueva",
      name: "La Cueva - Bukoto, Ntinda Road",
      type: "Nightclub",
      icon: Users,
    },
    {
      id: "patio",
      name: "Patio Bella - Arena Mall",
      type: "Restaurant",
      icon: Clock,
    },
    { id: "maze", name: "Maze - Forest Mall", type: "Restaurant", icon: Users },
    {
      id: "maze-bistro",
      name: "The Maze Bistro - Mbuya Ismael Road",
      type: "Restaurant",
      icon: Clock,
    },
  ];
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  {outlets.map((outlet) => {
                    const IconComponent = outlet.icon;
                    return (
                      <option
                        key={outlet.id}
                        value={outlet.id}
